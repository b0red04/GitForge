...
//!
//! The thin shells on `GitForgeApp` (`run_op_full`, `run_git_blocking`) live in
//! [`dispatch_shell`]; see `CONTEXT.md` → "Operation Dispatch".
//!
//! ## Error model
...
pub(crate) use super::dispatch_shell::ErrorHandler;
